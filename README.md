...
**Building with the Web?** Check out [awesome-webmcp](https://github.com/webfuse-com/awesome-webmcp) ⭐ 107 | 🐛 3 | 📅 2026-08-10 - a curated list of awesome things related to the WebMCP W3C standard.
...
* [anthropic-sdk-python](https://github.com/anthropics/anthropic-sdk-python) ⭐ 3,846 | 🐛 150 | 🌐 Python | 📅 2026-08-21 -  Python SDK with async support and type hints.
* [anthropic-sdk-typescript](https://github.com/anthropics/anthropic-sdk-typescript) ⭐ 2,094 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-21 -  TypeScript/JavaScript SDK for Node.js and browsers.
* [anthropic-sdk-go](https://github.com/anthropics/anthropic-sdk-go) ⭐ 1,180 | 🐛 41 | 🌐 Go | 📅 2026-08-21 -  Go SDK with idiomatic design.
* [anthropic-sdk-ruby](https://github.com/anthropics/anthropic-sdk-ruby) ⭐ 368 | 🐛 5 | 🌐 Ruby | 📅 2026-08-21 -  Ruby SDK.
* [anthropic-sdk-java](https://github.com/anthropics/anthropic-sdk-java) ⭐ 366 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-21 -  Java/Kotlin SDK with modern features.
...
* [claude-agent-sdk-python](https://github.com/anthropics/claude-agent-sdk-python) ⭐ 7,953 | 🐛 437 | 🌐 Python | 📅 2026-08-23 -  Python Agent SDK. [Docs](https://platform.claude.com/docs/en/agent-sdk/overview)
* [claude-agent-sdk-typescript](https://github.com/anthropics/claude-agent-sdk-typescript) ⭐ 1,712 | 🐛 189 | 🌐 Shell | 📅 2026-08-23 -  TypeScript Agent SDK.

**Starters**

* [Claude Cookbook](https://github.com/anthropics/claude-cookbooks) ⭐ 52,002 | 🐛 312 | 🌐 Jupyter Notebook | 📅 2026-08-19 -  Official notebooks and recipes for common patterns (RAG, tool use, Skills, MCP).
* [Claude Quickstarts](https://github.com/anthropics/claude-quickstarts) ⭐ 17,513 | 🐛 196 | 🌐 TypeScript | 📅 2026-08-21 -  Ready-to-deploy example apps.
...
* [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers#readme) ⭐ 92,699 | 🐛 3,354 | 📅 2026-08-17 -  Curated community list of MCP servers.
...
* [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers#readme) ⭐ 92,699 | 🐛 3,354 | 📅 2026-08-17 -  Curated list of Model Context Protocol (MCP) servers for extending Claude's capabilities.
* [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code#readme) ⭐ 52,836 | 🐛 916 | 🌐 Python | 📅 2026-08-23 -  Slash-commands, CLAUDE.md files, CLI tools, and workflows for Claude Code.
* [VoltAgent/awesome-claude-code-subagents](https://github.com/VoltAgent/awesome-claude-code-subagents#readme) ⭐ 24,552 | 🐛 6 | 🌐 Shell | 📅 2026-08-12 -  100+ specialized AI agents for full-stack development maintained by the community.
* [travisvn/awesome-claude-skills](https://github.com/travisvn/awesome-claude-skills#readme) ⭐ 14,777 | 🐛 748 | 📅 2026-04-28 -  Resources and tools for customizing AI workflows with Claude Skills.
* [BehiSecc/awesome-claude-skills](https://github.com/BehiSecc/awesome-claude-skills#readme) ⭐ 10,042 | 🐛 85 | 📅 2026-08-02 -  Categorized skills for document handling, development tools, data analysis, and more.
* [langgptai/awesome-claude-prompts](https://github.com/langgptai/awesome-claude-prompts#readme) ⭐ 5,434 | 🐛 19 | 📅 2026-02-28 -  Collection of prompt examples designed to improve Claude interactions.
* [vijaythecoder/awesome-claude-agents](https://github.com/vijaythecoder/awesome-claude-agents#readme) ⭐ 4,385 | 🐛 46 | 📅 2025-10-30 -  Team of specialized AI agents for building features and debugging.
...
* [Claude Desktop Debian](https://github.com/aaddrick/claude-desktop-debian#readme) ⭐ 5,353 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-22 -  Unofficial Claude desktop app for Debian/Linux.
...
* [40+ Claude Code Tips](https://github.com/ykdojo/claude-code-tips#readme) ⭐ 9,852 | 🐛 4 | 🌐 HTML | 📅 2026-08-22 -  Tips for getting the most out of Claude Code, including a custom status line script, cutting the system prompt in half, using Gemini CLI as Claude Code's minion, and Claude Code running itself in a container. Also includes the dx plugin for GitHub Actions debugging, conversation cloning, and handoffs.
* [Claude Code Everything You Need to Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know#readme) ⭐ 2,679 | 🐛 7 | 🌐 Python | 📅 2026-07-28 -  Ultimate all-in-one guide to mastering Claude Code. Covers setup, prompt engineering, commands, hooks, workflows, automation, integrations, MCP servers, and the BMAD method.
